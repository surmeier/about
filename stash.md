Hi, my name is Jones. I currently work in the [Prescience Lab](http://presciencelab.org/), led by Professor Peter Dinda. I'm a dual major in computer science and mathematics at Northwestern; I expect to graduate by June 2025. 
...
- I'm highly proficient in `Haskell`, `C`, `Koka`, `Lean`, `Julia/OSCAR.jl`, `Nix`, and `Janet`.

- I have high familiarity with and am actively learning `Rzk`, `F*/Low*`, `Quint`, `Dhall`, `jq`, `Sail DSL`, and `RISC-V Assembly`.
