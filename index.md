...
- I'm highly proficient in `Haskell`, `C`, `Koka`, `Lean`, `Julia/OSCAR.jl`, `Scala`, and `Janet`.

- I have high familiarity with and am actively learning `Rzk`, `F*/Low*`, `Quint`, `Nix`, `Dhall`, `jq`, and `RISC-V Assembly`.
...
“The valor that struggles is better than the weakness that endures.” - Hegel. "I always finish my side projects." - Me
